...
<body>
  ...
  <section id="detail_lapangan" class="about" style="padding-top:120px">
      <h2>Detail <span><?= $lapangan['nama'] ?></span> </h2>
      <img src="../img/<?= $lapangan["foto"]; ?>" alt="Gambar Lapangan" style="border-radius: 6px; width: 60%; height: 60%; display: block; margin: auto;">
    <!-- Deskripsi -->
      <div class="row mt-4">
        <div class="contain">
          <div class="about-img" data-aos="fade-right" data-aos-duration="1000">
            <h4 class="mb-3" style="color:#ff9800;">Deskripsi</h4>
            <p style="text-align:justify;"><?= $lapangan['keterangan'] ?></p>
          </div>
        </div>
      </div>
    <!-- End Deskripsi -->
     <!-- Harga -->
      <div class="row mt-4">
        <div class="contain">
          <div class="about-img" data-aos="fade-right" data-aos-duration="1000">
            <h4 class="mb-3" style="color:#ff9800;">Daftar Harga</h4>
            <p style="text-align:justify;">[08:00-12:00] Harga: Rp. <?= $lapangan['harga1'] ?>,-</p>
            <p style="text-align:justify;">[13:00-18:00] Harga: Rp. <?= $lapangan['harga2'] ?>,-</p>
            <p style="text-align:justify;">[19:00-23:00] Harga: Rp. <?= $lapangan['harga3'] ?>,-</p>
          </div>
        </div>
      </div>
      <!-- End Harga -->
       <!-- Jadwal -->
        <div class="contain mt-4" data-aos="fade-left" data-aos-duration="1000">
          <h4 class="text-left mb-2" style="color:#ff9800;">Jadwal Lapangan yang sudah Dipesan</h4>
          <p style="text-align:justify;">Jadwal pada tabel dibawah ini merupakan jadwal yang telah dipesan oleh pelanggan. 
          Untuk memesan lapangan, silakan login terlebih dahulu untuk memesan jadwal yang diinginkan.</p>
            ...
            <tbody>
              <?php
                ...
                foreach ($data as $row) {
                  ...
                  echo "<td> Lapangan telah dipesan</td>";
                  echo "</tr>";
                }
                ?>
            </tbody>
