                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group form-group-default">
                                                                    ...
                                                                    <textarea id="addKeterangan" rows="5"
                                                        ...
                                                        <td>
                                                            <div class="form-button-action">
                                                                ...
                                                                <button type="button" title=""
                                                                    ...
                                                                    <a
                                                                        href="./controller/hapusEvent.php?id=<?= $row["id"]; ?>"><i
