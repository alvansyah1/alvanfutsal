...
// Ambil data pesanan yang belum dibayar dan diurutkan berdasarkan tanggal pesan dan jam mulai terbaru
$pesan = query("SELECT sewa.*, lapangan.nama, user.nama_lengkap 
                FROM sewa 
                JOIN lapangan ON sewa.id_lapangan = lapangan.id_lapangan
                JOIN user ON sewa.id_user = user.id_user 
                WHERE id_sewa NOT IN (SELECT id_sewa FROM bayar WHERE konfirmasi = 'Sudah Bayar' OR konfirmasi = 'Terkonfirmasi') 
                ORDER BY tanggal_pesan DESC, jam_mulai DESC");
?>
...
<head>
    ...
    <title>Pemesanan | BP Futsal</title>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex align-items-center">
                                        <h4 class="card-title">Lihat Data Pemesanan (Belum Bayar)</h4>
                                    </div>
                                </div>
                                <div class="card-body">
                                                        ...
                                                        <td>
                                                            <div class="form-button-action">
                                                                <button type="button" title=""
                                                                    ...
                                                                    <a
                                                                        href="./controller/hapusAdmin.php?id=<?= $row["id_sewa"]; ?>"><i
